...
<div class="container-fluid">
    ...
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card">
                    <h3 class="card-header text-center">Modifier enfant</h3>
                    <div class="card-body">
                         @if ($errors->any())
                           ...
                           @endif
                    <form action="{{ route('enfants.update', $enfant->id)}}" method="post" style="display: inline-block">
                    @csrf
                    @method('PUT')
                    @if ($errors->any())
                    <div class="alert alert-danger">
                    ...
                    <div class="form-group mb-3">
                        <input value="{{$enfant->nom}}" type="text" placeholder="Nom" id="nom" class="form-control" name="nom" required
                            autofocus>
                        @if ($errors->has('nom'))
                    ...
                    <div class="form-group mb-3">
                        <input value="{{$enfant->prenom}}" type="text" placeholder="Prenom" id="prenom" class="form-control" name="prenom" required
                            autofocus>
                    ...
                    <div class="form-group mb-3">
                        <input value="{{$enfant->date_naissance}}" type="date" placeholder="Date de naissance" id="date_naissance" class="form-control" name="date_naissance" required
                            autofocus>
