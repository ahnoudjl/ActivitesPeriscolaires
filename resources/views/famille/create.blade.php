                ...
                <div class="card">
                    ...
                    <div class="card-body">
                         @if ($errors->any())
                           ...
                           @endif
        <form action="{{ route('familles.store')}}" method="post" style="display: inline-block">
        @csrf
                    @if ($errors->any())
                    <div class="alert alert-danger">
                        <ul>
                    ...
                    <div class="form-group mb-3">
                        <input type="text" placeholder="N° Telepnone fixe" id="tel_fixe" class="form-control" name="tel_fixe" required
                            autofocus>
                    ...
                    <div class="form-group mb-3">
                        <input type="text" placeholder="N° Telepnone portable" id="tel_portable" class="form-control" name="tel_portable" required
                            autofocus>
                    ...
                    <div class="form-group mb-3">
                        <input type="text" placeholder="N° Telepnone travail" id="tel_travail" class="form-control" name="tel_travail" required
                            autofocus>
                    ...
                    <div class="form-group mb-3">
                        <input type="text" placeholder="Reamrques..." id="remarques" class="form-control" name="remarques" required
                            autofocus>
                    ...
                    <div class="form-group mb-3">
                        <input type="text" placeholder="N° CAF" id="n_caf" class="form-control" name="n_caf" required
                            autofocus>
                        @if ($errors->has('n_caf'))
