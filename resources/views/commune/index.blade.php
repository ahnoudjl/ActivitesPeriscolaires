  ...
  <table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="{{ route('communes.show', $commune->id)}}">{{$commune->titre}}</a></td>
            <td>{{  $commune->created_at->diffForHumans() }}</td>
            <td class="text-center">
                <a href="{{ route('communes.edit', $commune->id)}}" class="btn btn-primary btn-sm"">Edit</a>
