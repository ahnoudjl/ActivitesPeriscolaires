...
@section('title', 'Ajouter association')
...
<div class="container-fluid">
    ...
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card">
                    <h3 class="card-header text-center">Creer Association</h3>
                    <div class="card-body">
                         @if ($errors->any())
                        ...
                        <form method="POST" action="{{ route('associations.store') }}">
                            ...
                            <div class="form-group mb-3">
                                <input type="text" placeholder="Titre association" id="titre" class="form-control" name="titre" required
                                    autofocus>
                                @if ($errors->has('title'))
