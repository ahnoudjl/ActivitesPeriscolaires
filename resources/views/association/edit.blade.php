...
<div class="container-fluid">
    ...
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card">
                    <h3 class="card-header text-center">Modifier Association</h3>
                    <div class="card-body">
                         @if ($errors->any())
                        ...
                        <form method="POST" action="{{ route('associations.update', $association->id) }}">
                            ...
                            <div class="form-group mb-3">
                                <input type="text" placeholder="Titre association" id="titre" class="form-control" name="titre" value="{{ $association->titre }}" required
                                    autofocus>
                                @if ($errors->has('title'))
                            ...
                            <div class="form-group mb-3">
                                ...
                                <span class="text-danger">{{ $errors->first('commune_id') }}</span>
                                @endif
                            </div>
                            <div class="d-grid mx-auto">
                                <button type="submit" class="btn btn-dark btn-block">Confirmer</button>
                            </div>
                        </form>
                    </div>
                </div>
