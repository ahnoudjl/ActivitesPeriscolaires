...
<div class="push-top">
  ...
  @endif
        ...
        <form action="{{ route('gestionnaires.update', $gestionnaire->id)}}" method="post" style="display: inline-block">
        @csrf
        @method('PUT')
        @if ($errors->any())
        ...
        <div>
          ...
          <option value="{{$activite->id}}">{{$activite->name}}, {{$activite->prenom}}, {{$activite->email}}</option>                                      
        ...
        <div>
          ...
          <select name="enfant_id" id="enfant_id">
          @foreach($enfants as $enfant)
          <option value="{{$enfant->id}}">{{$enfant->titre}}</option>                                       
          @endforeach
          </select>
        </div>
