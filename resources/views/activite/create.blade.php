...
@section('title', 'Ajouter activite')
@section('content')
<div class="container-fluid">
    ...
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card">
                    <h3 class="card-header text-center">Creer activite</h3>
                    <div class="card-body">
                         @if ($errors->any())
                           ...
                           @endif
        <form action="{{ route('activites.store')}}" method="post" style="display: inline-block">
        @csrf
                    @if ($errors->any())
                    <div class="alert alert-danger">
                        <ul>
                    ...
                    <div class="form-group mb-3">
                        <input type="text" placeholder="Titre" id="titre" class="form-control" name="titre" required
                            autofocus>
                        @if ($errors->has('titre'))
                    ...
                    <div class="form-group mb-3">
                        <input type="text" placeholder="Prix" id="prix" class="form-control" name="prix" required
                            autofocus>
                        @if ($errors->has('prix'))
                    ...
                    <div class="form-group mb-3">
                        <input type="text" placeholder="Capacite" id="capacite" class="form-control" name="capacite" required
                            autofocus>
