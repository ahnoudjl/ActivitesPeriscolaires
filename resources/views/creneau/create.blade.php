...
<div class="container-fluid">
    ...
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card">
                    <h3 class="card-header text-center">Creer creneau</h3>
                    <div class="card-body">
                         @if ($errors->any())
                           ...
                           @endif
        <form action="{{ route('creneaus.store')}}" method="post" style="display: inline-block">
        @csrf
                    @if ($errors->any())
                    <div class="alert alert-danger">
                        <ul>
                    ...
                    <div class="form-group mb-3">
                        <input type="date" placeholder="Jour" id="jour" class="form-control" name="jour" required
                            autofocus>
                        @if ($errors->has('jour'))
                    ...
                    <div class="form-group mb-3">
                        <input type="time" placeholder="Debut periode" id="debut_periode" class="form-control" name="debut_periode" required
                            autofocus>
                    ...
                    <div class="form-group mb-3">
                        <input type="time" placeholder="Fin periode" id="fin_periode" class="form-control" name="fin_periode" required
                            autofocus>
